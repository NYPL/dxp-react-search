...
export DS_GLOBAL_HEADER=https://ds-header.nypl.org/header.min.js?containerId=nypl-header
echo "DS_GLOBAL_HEADER: $DS_GLOBAL_HEADER"

export DS_GLOBAL_FOOTER=https://ds-header.nypl.org/footer.min.js?containerId=nypl-footer
echo "DS_GLOBAL_FOOTER: $DS_GLOBAL_FOOTER"
