...
export NEXT_PUBLIC_ADOBE_LAUNCH_URL=https://assets.adobedtm.com/1a9376472d37/8519dfce636d/launch-bf8436264b01-development.min.js
echo "NEXT_PUBLIC_ADOBE_LAUNCH_URL: $NEXT_PUBLIC_ADOBE_LAUNCH_URL"
